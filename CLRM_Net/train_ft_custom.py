...
from dataset.custom_pseudo_dataset import CustomPseudoDataSet
...
DATA_LIST_PATH_TARGET = './dataset/custom_real_list/train.txt'
...
def main():
    ...
    trainloader = data.DataLoader(
        CustomPseudoDataSet(args.data_dir, args.data_list, max_iters=args.num_steps * args.iter_size * args.batch_size,
