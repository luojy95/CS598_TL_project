...
def configure():
	...
	# training
	flags.DEFINE_integer('num_steps', 40000, 'maximum number of iterations')
	flags.DEFINE_integer('save_interval', 2000, 'number of iterations for saving and visualization')
	...
	flags.DEFINE_integer('valid_num_steps', 356, '= number of validation samples')
	flags.DEFINE_string('valid_data_list', './dataset/train.txt', 'validation data list filename')
	...
	flags.DEFINE_integer('test_num_steps', 356, '= number of testing/validation samples')
	flags.DEFINE_string('test_data_list', './dataset/train.txt', 'testing/validation data list filename')
	flags.DEFINE_boolean('visual', True, 'whether to save predictions for visualization')

	# data
	flags.DEFINE_string('data_dir', '/home/junz/Desktop/Deeplab-v2--ResNet-101--Tensorflow/dataset/', 'data directory')
	flags.DEFINE_integer('batch_size', 2, 'training batch size')
	flags.DEFINE_integer('input_height', 440, 'input image height')
	flags.DEFINE_integer('input_width', 244, 'input image width')
