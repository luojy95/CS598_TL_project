...
class CustomSyntheticDataSet(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(f"synthetic image shape:{image.shape}, synthetic label shape:{label.shape}")
...
if __name__ == '__main__':
    dst = CustomSyntheticDataSet('../data/custom_synthetic/', '../dataset/custom_synthetic_list/train.txt', mean=(0,0,0), autoaug=True)
