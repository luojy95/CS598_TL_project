...
DATA_LIST_PATH = './dataset/custom_real_list/train.txt'
SAVE_PATH = './data/custom_real/pseudo/train'

if not os.path.isdir('./data/custom_real/pseudo/'):
    os.mkdir('./data/custom_real/pseudo/')
    os.mkdir(SAVE_PATH)
...
def main():
    ...
    if version.parse(torch.__version__) >= version.parse('0.4.0'):
        interp = nn.Upsample(size=(448, 880), mode='bilinear', align_corners=True)
    else:
        interp = nn.Upsample(size=(448, 880), mode='bilinear')
